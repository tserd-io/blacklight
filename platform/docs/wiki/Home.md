<p align="center">
  <img src="assets/blacklight-studio-wiki-header-console.png" alt="Blacklight Studio console wiki header: AI workflow platform starter" width="100%">
</p>
...
| --- | --- | --- |
| Understand the system shape | [Architecture](architecture) | Component boundaries, request flow, and how the platform pieces fit together |
| Configure model backends | [Provider Configuration](provider-configuration) | Mock, OpenAI, custom provider, and Ollama setup notes |
| Build my own workflow | [Create Your Own Workflow](create-your-own-workflow) | A practical path for adapting the starter to a new use case |
| Review release scope | [Release Notes](release-notes) | Current version notes and user-facing capabilities |
...
1. [Architecture](architecture) - see the core request flow.
2. [Provider Configuration](provider-configuration) - choose mock, OpenAI, custom provider, or Ollama.
3. [Create Your Own Workflow](create-your-own-workflow) - adapt the starter to a real team workflow.
4. [Eval Methodology](eval-methodology) - understand how quality checks are structured.
5. [Operational Cost and Ownership](operational-cost-and-ownership) - plan cost visibility and ownership.

## Operator Notes

| Topic | Page |
| --- | --- |
| Failure handling | [Failure Modes](failure-modes) |
| Design tradeoffs | [Tradeoffs](tradeoffs) |
| Packaging direction | [Desktop Packaging](desktop-packaging) |
